...
### Tweak module import
from tweak_generation.tweak_beam_search import tweak_beam_search
...
def generate(
    ...
    **kwargs,
    ...
    if is_greedy_gen_mode:
        ...
        # 11. Initilize tweak logit processor, with initial model_kwargs (i.e., single encoder_outputs before expanding)
        # move this outside this function for avoiding duplicate initilaisation
        ...
        # 14. run tweak beam search
        return tweak_beam_search(
            model,
            source_inputs=inputs_tensor,
            input_ids=input_ids,
            beam_scorer=beam_scorer,
            logits_processor=logits_processor,
            tweak_processor=tweak_processor,
            stopping_criteria=stopping_criteria,
            pad_token_id=generation_config.pad_token_id,
            eos_token_id=generation_config.eos_token_id,
            output_scores=generation_config.output_scores,
